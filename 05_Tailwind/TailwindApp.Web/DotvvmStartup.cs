...
public class DotvvmStartup : IDotvvmStartup, IDotvvmServiceConfigurator
{
    ...
    {
        config.RouteTable.Add("Overview", "", "Pages/Overview/overview.dothtml");
        config.RouteTable.Add("Campaigns", "campaigns", "Pages/Campaigns/campaigns.dothtml");
        config.RouteTable.Add("Audience", "audience", "Pages/Audience/audience.dothtml");
